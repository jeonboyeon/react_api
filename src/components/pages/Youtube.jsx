...
const Youtube = () => {
    ...
    //     await fetch(
    //         `https://youtube.googleapis.com/youtube/v3/search?part=snippet&q=${query}&key=AIzaSyCBk8G_DrF1XOmXvzm9-VoJDLeNgBpmJII&maxResults=20&type=video`
    //     )
    ...
    useEffect(() => {
        fetch("https://jeonboyeon.github.io/react_api/src/util/youtube.json")
            ...
            .catch((error) => console.log(error));
        // fetch(
        //     "https://youtube.googleapis.com/youtube/v3/search?part=snippet&q=webstoryboy&key=AIzaSyBenl9UdKbF06EZbQpp2Tn-mvbrj3jJvDo&maxResults=20&type=video"
        // )
        //     .then((response) => response.json())
        //     .then((result) => console.log(result))
